ROUTER_INSTRUCTIONS = (
    ...
    "Return JSON with a single key 'datasource' that is 'websearch' or 'vectorstore'."
)
...
DOC_GRADER_PROMPT = (
    ...
    "This carefully and objectively assess whether the document contains at least "
    "some information that is relevant to the question.\n"
    "Return JSON with a single key 'binary_score' that is 'yes' or 'no' to indicate "
...
HALLUCINATION_GRADER_PROMPT = (
    ...
    "Return JSON with two keys: 'binary_score' is 'yes' or 'no' score to indicate "
    "whether the STUDENT ANSWER is grounded in the FACTS. "
...
ANSWER_GRADER_PROMPT = (
    ...
    "STUDENT ANSWER: {generation}\n\n"
    "Return JSON with two keys: 'binary_score' is 'yes' or 'no' score to indicate "
    "whether the STUDENT ANSWER meets the criteria. "
    "And a key 'explanation' that contains an explanation of the score."
)
